...
// #刻晴 #老婆
export const avatarCard = false

// #深渊
export const uploadAbyssData = false

// #幻想
export const roleCombat = false
...
/** ************ 【角色面板相关设置】 ************* */
// 面板查询
export const avatarProfile = false

// 面板替换
export const profileChange = false
...
/** ************ 【角色资料与信息查询】 ************* */
// #刻晴图鉴 的图鉴信息
export const charWiki = false

// #刻晴天赋/#刻晴命座 的天赋信息
export const charWikiTalent = false

// 开启时才能查看未实装角色信息。数据仅供参考，请以游戏正式实装内容为准
export const notReleasedData = false

// 角色图片
export const charPic = false
